...
public class Login1 extends JFrame  {
	...
	public Login1() {
		...
		TextPrompt con = new TextPrompt("Digite su contrase√±a", password);
...
<<<<<<< HEAD
		...
		TextPrompt conR = new TextPrompt("Digite su contraseÒa", passwordR);
